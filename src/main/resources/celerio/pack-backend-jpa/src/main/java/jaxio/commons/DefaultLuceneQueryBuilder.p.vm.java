$output.java($JaxioCommons, "DefaultLuceneQueryBuilder")##

$output.require("org.apache.lucene.analysis.miscellaneous.ASCIIFoldingFilter")##
$output.require("org.apache.lucene.queryparser.classic.QueryParser")##
